        ...
        return (
            <>
                ...
                <div className="md:hidden flex items-center gap-1">
                    ...
                    >
                        <svg className="w-5 h-5" fill={wishlistCount > 0 ? "#C2185B" : "none"} stroke="#C2185B" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <ul className="flex flex-col space-y-1" role="list">
                        ...
                        <li>
                            <div className="flex gap-2 pt-1">
                                ...
                                >
                                    <svg className="w-4 h-4" fill={wishlistCount > 0 ? "#C2185B" : "none"} stroke="#C2185B" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                    </svg>
                                    <span>Wishlist</span>
