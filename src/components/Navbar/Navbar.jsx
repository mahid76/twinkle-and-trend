        ...
        <div className="flex items-center justify-between py-2">
          ...
          <ul className="hidden font-secondary md:flex space-x-6 text-sm items-center">
            ...
            <li className="relative group" ref={dropdownRef}>
              ...
              <ul className={`absolute top-12 left-0 bg-white text-black w-48 rounded-md shadow-lg transition-all duration-200 z-50 ${
          ...
          <div className="hidden md:flex items-center w-64">
            <input
              ...
              className="px-3 py-1 text-black bg-amber-50 rounded-l-md outline-none w-full focus:ring-teal-400"
            />
            <button className="bg-teal-500 px-4 py-1 rounded-r-md cursor-pointer hover:bg-teal-600">
              Search
            </button>
          </div>
        ...
        <div className="md:hidden bg-gray-800 border-t border-gray-700">
          <Container>
            <ul className="flex flex-col space-y-2 p-4">
              <li className="hover:text-gray-300 px-4 py-3 cursor-pointer">
                Home
              </li>
              <li className="hover:text-gray-300 px-4 py-3 cursor-pointer">
                Offers
