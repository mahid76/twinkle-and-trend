              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  {product.stock < 10 && product.stock > 0 && (
                    <div className="absolute top-2 left-2 bg-[#E771A3] text-white px-3 py-1 rounded-full text-xs">
                  ...
                  {/* Discount Badge */}
                  {hasOffer && (
                    <div className="absolute top-2 right-2 bg-[#E771A3] text-white px-3 py-1 rounded-full text-xs font-bold">
                      {discount}% OFF
                    </div>
                  )}
                  ...
                  {product.isBestSeller && (
                    <div className="absolute top-2 left-2 bg-[#F6D6DF] text-[#E771A3] px-3 py-1 rounded-full text-xs font-bold">
                      ⭐ Best Seller
                    </div>
                  )}
                ...
                <div className="p-3 md:p-4">
                  ...
                  {/* Button */}
                  <button className="w-full bg-[#E771A3] text-white px-4 py-2 rounded-md hover:bg-[#d15f93] transition-all duration-300 hover:scale-[1.02]">
                    View Details
                  </button>
