...
const SIZES = "(max-width: 640px) 90vw, (max-width: 1024px) 45vw, 25vw";
          ...
          {visibleProducts.map((product, idx) => {
            ...
            return (
              <Link
                ...
                aria-label={`${product.name} — ৳${hasOffer ? product.offerPrice : product.price}`}
              ...
              >
                <div className="relative overflow-hidden">
                  <div className="relative overflow-hidden aspect-[4/5]" onContextMenu={(e) => e.preventDefault()}>
                    <img
                      ...
                      sizes={SIZES}
                      alt={product.name}
                      // ✅ প্রথম 4টা image eager (viewport এ থাকে), বাকি lazy
                  ...
                  {product.stock === 0 && <div className="absolute top-2 left-2 bg-red-500 text-white px-2 md:px-3 py-1 text-[10px] md:text-sm rounded-full font-medium" role="status">Out of Stock</div>}
                  {product.stock < 10 && product.stock > 0 && <div className="absolute top-10 left-2 bg-[#E771A3] text-white px-2 md:px-3 py-1 text-[10px] md:text-sm rounded-full font-medium" role="status">Only {product.stock} left!</div>}
                ...
                <div className="px-2 py-2 md:p-4">
                  ...
                  <h3 className="text-md md:text-xl mb-2 font-semibold text-gray-800 line-clamp-2">{product.name}</h3>
