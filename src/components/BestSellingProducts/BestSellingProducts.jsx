...
const BestSellingProducts = () => {
    ...
    if (loading) {
        return (
            <div className="max-w-7xl mx-auto py-12 px-4">
                <h2 className="text-2xl sm:text-4xl font-primary font-bold text-gray-800 mb-2">Best Selling Products</h2>
                <div className="flex items-center justify-center min-h-[400px]">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-teal-500" aria-label="Loading products" role="status" />
                </div>
            </div>
        );
    }
    ...
    return (
        <section className="max-w-7xl mx-auto py-4 md:py-8 px-4" aria-labelledby="best-sellers-heading">
            <div className="mb-6 md:mb-10">
                <h2 id="best-sellers-heading" className="text-2xl text-center sm:text-4xl font-primary font-bold text-gray-800 mb-2">
            ...
            <div className="relative group">
                <Swiper
                    ...
                    // ✅ FIX: navigation={true} সরানো হয়েছে — এটাই DMTokenList error এর কারণ ছিল
                    // Custom pagination ব্যবহার করা হচ্ছে
                                    ...
                                    <div className="flex justify-center md:block">
                                        <div className="bg-white rounded-xl shadow p-2 md:p-4 border border-slate-100 hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                                            <div className="relative overflow-hidden rounded-lg max-w-70 md:w-full">
                                                ...
                                                >
                                                    <svg className="w-4 h-4" fill={wishlisted ? "#E771A3" : "none"} stroke="#E771A3" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                                    </svg>
                                                </button>

                                                {product.stock === 0 && (
                                                    <div className="absolute top-2 left-2 bg-red-500 text-white px-2 md:px-3 py-1 text-[10px] md:text-sm rounded-full font-medium" role="status">
                                                        Out of Stock
                                                    </div>
                                                )}
                                                {product.stock < 10 && product.stock > 0 && (
                                                    <div className="absolute top-10 left-2 bg-[#E771A3] text-white px-2 md:px-3 py-1 text-[10px] md:text-sm rounded-full font-medium" role="status">
                ...
                <div className="custom-pagination flex justify-center gap-2 mt-8" role="tablist" aria-label="Slide navigation" />
            </div>
