                            ...
                            {filteredProducts.map((product) => {
                                ...
                                return (
                                    <SwiperSlide key={product.id}>
                                        <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100 mb-4 h-full">
                                            <div className="relative overflow-hidden">
                                                ...
                                                <div className="absolute top-4 right-4 bg-[#E771A3] text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">
                                                    {discount}% OFF
                                                </div>
                                            </div>
