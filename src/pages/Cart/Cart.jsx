			...
			<div className="py-5 md:py-8">
				...
				<div className="flex flex-col lg:flex-row gap-5">
							...
							>
								...
								<div className="flex-1 min-w-0">
									...
									<div className="flex items-center gap-2 mt-1.5">
										<span className="text-[#E771A3] font-bold text-sm">
											Tk.{item.price}
										</span>
										{item.originalPrice && (
					...
					<div className="w-full lg:w-[22rem] flex-shrink-0">
						<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 lg:sticky lg:top-4 space-y-4">
							{/* Delivery Details */}
							<div>
							...
							<div>
								...
								<div className="flex flex-col gap-1.5">
									...
									>
										...
										<span
											className={`font-semibold text-[11px] ${deliveryZone === "inside" ? "text-[#E771A3]" : "text-gray-400"}`}
										>
											+Tk.60
										</span>
									</button>
									...
									>
										...
										<span
											className={`font-semibold text-[11px] ${deliveryZone === "outside" ? "text-[#E771A3]" : "text-gray-400"}`}
										>
											+Tk.120
										</span>
									</button>
