							...
							<div>
								...
								<div className="flex flex-col gap-1.5">
									...
									>
										...
										<span className={`font-semibold text-[11px] ${deliveryZone === "inside" ? "text-[#E771A3]" : "text-gray-400"}`}>+Tk.60</span>
									</button>
									...
									>
										...
										<span className={`font-semibold text-[11px] ${deliveryZone === "outside" ? "text-[#E771A3]" : "text-gray-400"}`}>+Tk.120</span>
									</button>
								</div>
								{errors.deliveryZone && (
