...
Please confirm my order!
	...
	// Handle Send Message on Facebook Messenger
...
Please confirm my order!
			...
			const encodedMessage = encodeURIComponent(message);
			const messengerUrl = `https://m.me/${facebookPageUsername}?ref=product&message=${encodedMessage}`;
			window.open(messengerUrl, "_blank");
		}
	};

	// Handle Visit Facebook Page
	...
	return (
		<Container>
			...
			<div className="block md:flex md:justify-between mb-8 md:mb-12 ">
				<div className="product-image flex justify-between items-center md:items-baseline md:block">
					<div
						className="relative overflow-hidden aspect-4/5 max-w-[310px] md:max-w-[450px] mx-auto rounded-lg"
					...
					{/* Thumbnail Images */}
					<div className="image-thumb md:mt-4">
						<div className="flex  flex-col md:flex-row md:justify-between gap-2">
							{product.images.map((img, index) => (
								<button
									key={index}
									onClick={() => setActiveImage(index)}
									className={`border-2 w-fit rounded-lg overflow-hidden transition-all ${
										activeImage === index
								...
								>
									<div
										className="relative overflow-hidden aspect-4/5 max-w-[50px] md:max-w-[100px] "
										onContextMenu={(e) => e.preventDefault()}
									>
										<img
											draggable="false"
